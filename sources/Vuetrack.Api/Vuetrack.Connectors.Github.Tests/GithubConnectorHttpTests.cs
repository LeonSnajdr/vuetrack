...
public class GithubConnectorHttpTests
{
    ...
    private static GithubConnector BuildConnector(Func<HttpRequestMessage, HttpResponseMessage> responder, int pageSize = 100)
    {
        ...
        var accessor = new GithubConnectionAccessor
        {
            Current = new GithubConnectionContainer
            {
                UserId = "user-1",
        ...
        var client = new GithubApiClient(httpClient, accessor, options, NullLogger<GithubApiClient>.Instance);
