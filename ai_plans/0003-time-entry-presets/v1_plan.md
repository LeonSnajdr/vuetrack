...
- [ ] Users can create and edit presets from the sidebar, where `name` is required and `taskId`, `duration`, `projectId`, and `activityId` are optional.
